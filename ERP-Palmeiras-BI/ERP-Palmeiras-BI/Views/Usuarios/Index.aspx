...
<% 
    IEnumerable<ERP_Palmeiras_BI.Models.Usuario> usuarios = (IEnumerable<ERP_Palmeiras_BI.Models.Usuario>)ViewBag.usuarios;  
 %>
...
<table id="funcionariosTable" class="decoratedTable">
            ...
            <% foreach (ERP_Palmeiras_BI.Models.Usuario u in usuarios)
               { %>
					<tr>
						<td><%= u.Login %></td>
